...
Minimal deduplication record written to `data/notified.json` after each successful broadcast. Only the fields strictly necessary for deduplication are stored.
