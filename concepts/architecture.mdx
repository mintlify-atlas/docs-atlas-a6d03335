...
<Tabs>
  <Tab title="Cron broadcast path">
    <Steps>
      ...
      <Step title="Format and broadcast">
  ...
  <Tab title="/deals command path">
    <Steps>
      ...
      <Step title="Response sent">
        The bot calls `getExchangeRate()` to get the current USD → COP rate (cached for 12 hours), formats the `FilteredDeal[]` with both COP and USD prices, and sends the HTML message to the requesting chat.
      </Step>
    </Steps>
  </Tab>
</Tabs>
